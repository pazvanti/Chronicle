...
export interface TranslationDictionary {
  ...
  settings: {
    ...
    createCustomThemeBtn: string;
    customizeStarterBtn: string;
    editThemeBtn: string;
    duplicateThemeBtn: string;
    deleteThemeBtn: string;
    exportThemeBtn: string;
    importThemeBtn: string;
    noCustomThemesYet: string;
    themeStudioTitle: string;
    themeStudioDesc: string;
    themeNameLabel: string;
    starterArchetypeLabel: string;
    quickSeedsLabel: string;
    accentColorLabel: string;
    appBackgroundLabel: string;
    sidebarBackgroundLabel: string;
    surfaceBackgroundLabel: string;
    elevatedBackgroundLabel: string;
    textPrimaryLabel: string;
    textSecondaryLabel: string;
    autoHarmonizeBtn: string;
    previewLiveToggle: string;
