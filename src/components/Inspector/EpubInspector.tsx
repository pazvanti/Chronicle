    ...
    <div style={{ flex: 1, overflowY: 'auto', padding: '2rem', maxWidth: '960px', margin: '0 auto', width: '100%' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
        <div style={{ background: 'var(--bg-surface)', padding: '1rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)' }}>
          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>{t('inspector.version')}</div>
        ...
        <div style={{ background: 'var(--bg-surface)', padding: '1rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)' }}>
          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>{t('inspector.totalChapters')}</div>
        ...
        <div style={{ background: 'var(--bg-surface)', padding: '1rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)' }}>
          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>{t('inspector.totalWords')}</div>
          <div style={{ fontSize: '1.4rem', fontWeight: 700, color: 'var(--text-primary)', marginTop: '0.2rem' }}>
        ...
        <div style={{ background: 'var(--bg-surface)', padding: '1rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)' }}>
          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>{t('inspector.totalAssetsSize')}</div>
          <div style={{ fontSize: '1.4rem', fontWeight: 700, color: 'var(--text-primary)', marginTop: '0.2rem' }}>
      ...
      <div style={{ background: 'var(--bg-surface)', padding: '1.25rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)', marginBottom: '1.5rem' }}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.8rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <span>{t('inspector.containerPaths')}</span>
        </h3>
        <div style={{ display: 'grid', gridTemplateColumns: '180px 1fr', gap: '0.5rem', fontSize: '0.85rem' }}>
          <span style={{ color: 'var(--text-muted)' }}>Rootfile OPF:</span>
          <code style={{ color: 'var(--accent-cyan)' }}>{book.opfPath}</code>

          <span style={{ color: 'var(--text-muted)' }}>EPUB3 Nav:</span>
          <code style={{ color: 'var(--accent-cyan)' }}>{book.navPath || 'nav.xhtml'}</code>

          <span style={{ color: 'var(--text-muted)' }}>EPUB2 NCX:</span>
          <code style={{ color: 'var(--accent-cyan)' }}>{book.tocPath || 'toc.ncx'}</code>

          <span style={{ color: 'var(--text-muted)' }}>Cover Manifest ID:</span>
          <code>{book.coverManifestId || '-'}</code>
        </div>
      </div>
      ...
      <div style={{ background: 'var(--bg-surface)', padding: '1.25rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)' }}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.8rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <span>{t('inspector.manifestItems')} ({Object.keys(book.manifest).length})</span>
        </h3>
